  ...
  class ProductVariantsController < BaseController
    ...
    def create
      ...
      if @product_variant.save
        redirect_to seller_product_path(@product), notice: "Variante criada com sucesso."
      else
    ...
    def update
      if @product_variant.update(product_variant_params)
        redirect_to seller_product_path(@product), notice: "Variante atualizada com sucesso."
      else
    ...
    def destroy
      ...
      redirect_to seller_product_path(@product), notice: "Variante removida."
    rescue ActiveRecord::InvalidForeignKey
      redirect_to seller_product_path(@product), alert: "Esta variante já foi usada em pedidos e não pode ser excluída — desative-a em vez disso."
    end
