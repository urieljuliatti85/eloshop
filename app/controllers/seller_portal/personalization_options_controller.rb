  ...
  class PersonalizationOptionsController < BaseController
    ...
    def create
      ...
      if @personalization_option.save
        redirect_to seller_product_path(@product), notice: "Campo de personalização criado com sucesso."
      else
    ...
    def update
      if @personalization_option.update(personalization_option_params)
        redirect_to seller_product_path(@product), notice: "Campo de personalização atualizado com sucesso."
      else
    ...
    def destroy
      ...
      redirect_to seller_product_path(@product), notice: "Campo de personalização removido."
    end
