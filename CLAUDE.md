...
- **Fase 22** — vínculo OAuth do vendedor com o Mercado Pago implementado (o provedor faz o KYC, a EloShop não coleta documentos, tokens ficam cifrados). Falta configurar a aplicação Marketplace de testes e validar o fluxo ponta a ponta. Bloqueada por dependência externa.
